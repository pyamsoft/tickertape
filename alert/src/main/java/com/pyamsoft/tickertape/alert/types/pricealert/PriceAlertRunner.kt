...
@Singleton
internal class PriceAlertRunner
@Inject
...
) : BaseRunner<PriceAlertWorkerParameters>() {

  override suspend fun performWork(params: PriceAlertWorkerParameters) = coroutineScope {
    ...
    try {
      ...
      standalone.notifyPriceAlerts(quotes)
    } catch (e: Throwable) {
      Timber.e(e, "Error getting watchlist quotes for price alerts")
    }
  }
}
