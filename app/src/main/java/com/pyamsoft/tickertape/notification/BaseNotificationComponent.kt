...
@Subcomponent
internal interface BaseNotificationComponent {

  @CheckResult fun plusNotificationComponent(): NotificationComponent.Factory

  /** Not actually used, just here so graph can compile */
  @CheckResult
  @Suppress("FunctionName")
  fun `$$daggerRequiredNotificationItemComponent`(): NotificationItemComponent.Factory
