...
import com.pyamsoft.tickertape.alert.ui.AlertScreen
import com.pyamsoft.tickertape.alert.ui.AlertViewModeler
...
class AlertFragment : Fragment(), FragmentNavigator.Screen<MainPage> {

  @JvmField @Inject internal var navigator: Navigator<MainPage>? = null
  @JvmField @Inject internal var viewModel: AlertViewModeler? = null
  ...
  companion object {
    ...
    fun newInstance(): Fragment {
      return AlertFragment().apply { arguments = Bundle.EMPTY }
    }
  }
}
